...
!function (e, t) {
    ...
    var n = function (e, t) {
            ...
            return t && l(i, t), i
        }, f = {contain: "xMidYMid meet", cover: "xMidYMid slice"}, g = {left: "start", center: "middle", right: "end"},
        p = function (e) {
            return function (t) {
                return d(e, {id: t.id})
            }
            ...
            }, rect: p("rect"), ellipse: p("ellipse"), text: p("text"), path: p("path"), line: function (e) {
            ...
            rect: function (e) {
                ...
                if (l(a, {x1: f.x, y1: f.y, x2: g.x, y2: g.y}), t.lineDecoration) {
                    ...
                    }({x: g.x - f.x, y: g.y - f.y}), m = h(.05, i, r);
                    if (-1 !== t.lineDecoration.indexOf("arrow-begin")) {
                        var y = n(p, m), E = o(f, y), v = c(f, 2, E), w = c(f, -2, E);
                        l(u, {
                            style: "display:block;",
                    ...
                    if (-1 !== t.lineDecoration.indexOf("arrow-end")) {
                        var _ = n(p, -m), I = o(g, _), M = c(g, 2, I), x = c(g, -2, I);
                        l(d, {
                            style: "display:block;",
            ...
            return e.utils.createView({
                ...
                write: function (e) {
                    ...
                    if (r.dirty) {
                        ...
                        if (n) {
                            var l = n.size, d = l && l.width, f = l && l.height, g = n.mode, p = n.upscale;
                            d && !f && (f = d), f && !d && (d = f);
                            var y = h < d && u < f;
                            if (!y || y && p) {
                                var v, I = d / h, M = f / u;
            ...
            return e.utils.createView({
                ...
                write: function (e) {
                    ...
                    var u = {x: 0, y: 0, width: s, height: h, center: {x: .5 * s, y: .5 * h}},
                        ...
                        g = 2 * Math.PI + a.rotation % (2 * Math.PI), p = a.aspectRatio || l.height / l.width,
                        m = void 0 === a.scaleToFit || a.scaleToFit, y = R(l, P(u, p), g, m ? a.center : {x: .5, y: .5}),
                        E = a.zoom * y;
        ...
        V = !1, O = 0, b = function () {
                    ...
                    write: function (e) {
                        ...
                        if (a.crop = o, a.markup = c, a.resize = s, a.dirty = h, a.opacity = r ? 0 : 1, !r && !t.rect.element.hidden) {
                            var u = n.height / n.width, l = o.aspectRatio || u, d = t.rect.inner.width,
                                f = t.rect.inner.height, g = t.query("GET_IMAGE_PREVIEW_HEIGHT"),
                                p = t.query("GET_IMAGE_PREVIEW_MIN_HEIGHT"), m = t.query("GET_IMAGE_PREVIEW_MAX_HEIGHT"),
                                y = t.query("GET_PANEL_ASPECT_RATIO"), E = t.query("GET_ALLOW_MULTIPLE");
                            y && !E && (g = d * y, l = y);
                            var v = null !== g ? g : Math.max(p, Math.min(d * l, m)), w = v / l;
                        ...
                        if (c) {
                            var s, h, u = URL.createObjectURL(c.file), l = function () {
                                ...
                                var l = Math.max(1, .75 * window.devicePixelRatio),
                                    d = t.query("GET_IMAGE_PREVIEW_ZOOM_FACTOR") * l, f = s / o, g = t.rect.element.width,
                                    p = t.rect.element.height, m = g, y = m * f;
                                f > 1 ? y = (m = Math.min(o, g * d)) * f : m = (y = Math.min(s, p * d)) / f;
                                var E = N(e, m, y, r), v = function () {
            ...
            var t = e.addFilter, i = e.utils, r = i.Type, a = i.createRoute, n = i.isFile, o = q(e);
                                ...
                                if (r) {
                                    ...
                                    if (!(a || n || o)) {
                                        ...
                                        if (s && h) {
                                            ...
                                            var p = h / s, m = (r.getMetadata("crop") || {}).aspectRatio || p,
