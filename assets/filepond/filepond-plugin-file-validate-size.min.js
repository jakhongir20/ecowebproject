...
!function (e, i) {
    ...
    "use strict";
    var e = function (e) {
        var i = e.addFilter, l = e.utils, E = l.Type, n = l.replaceInString, _ = l.toNaturalFileSize;
        return i("ALLOW_HOPPER_ITEM", function (e, i) {
            ...
            return new Promise(function (i, E) {
                ...
                if (null !== a && e.size >= a) E({
                    ...
                    if (null !== I && e.size <= I) E({
                        ...
                        if (null !== u) if (l("GET_ACTIVE_ITEMS").reduce(function (e, i) {
                            return e + i.fileSize
                        }, 0) > u) return void E({
                            status: {
                                main: l("GET_LABEL_MAX_TOTAL_FILE_SIZE_EXCEEDED"),
                                sub: n(l("GET_LABEL_MAX_TOTAL_FILE_SIZE"), {filesize: _(u)})
                            }
                        });
                        i(e)
                    }
            ...
            options: {
                ...
                labelMaxTotalFileSizeExceeded: ["Maximum total size exceeded", E.STRING],
                labelMaxTotalFileSize: ["Maximum total file size is {filesize}", E.STRING]
            }
        }
    };
