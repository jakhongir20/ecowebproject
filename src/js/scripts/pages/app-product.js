/*=========================================================================================
    File Name: app-product.js
    Description: app-product Javascripts
    ----------------------------------------------------------------------------------------
...
$(document).ready(function () {
  ...
  // init data table
  if ($(".product-data-table").length) {
    var dataListView = $(".product-data-table").DataTable({
      columnDefs: [
        {
          targets: 0,
          className: "control"
  ...
  var productFilterAction = $(".product-filter-action");
  var productOptions = $(".product-options");
  $(".action-btns").append(productFilterAction, productOptions);
  ...
  if ($(".product-item-repeater").length) {
    $(".product-item-repeater").repeater({
      show: function () {
        $(this).slideDown();
      },
  ...
  $(document).on("click", ".product-tax", function (e) {
    e.stopPropagation();
  });
  $(document).on("click", ".product-apply-btn", function () {
    var $this = $(this);
    var discount = $this
  ...
  $(document).on("change", ".product-item-select", function (e) {
    ...
    switch (selectOption) {
      case "Frest Admin Template":
        $(e.target)
          .closest(".product-item-filed")
          .find(".product-item-desc")
